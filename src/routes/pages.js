...
<head>
  ...
  <script>
    ...
    fbq('init','2786179745090865');
    fbq('track','PageView');
    fbq('track','Purchase',{value:0,currency:'USD'});
  </script>
  <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2786179745090865&ev=Purchase&noscript=1"/></noscript>
  <script>
